...
const FacultyRegistration = () => {
    ...
    function sendOTP() {
        setLoading(true)
        Axios.post(`${api}/sendOTPOnEMail`, { emailId: email, userType: "Faculty" })
            .then((res) => {
    ...
    function handleSecondStep(e) {
        ...
        if (file) {
            ...
            Axios.post(`${api}/service/checkAndEmail`, { email, modelToCheck: 'User', filter: { username: username }, type: 'faculty' }).then(function (res) {
    ...
    function handleRegistration(e) {
        ...
        Axios.post(`${api}/api/auth/register`, formData).then(function (response) {
                                    ...
                                    <div>
                                        <div>
                                            {!avatar ?
                                                ...
                                                gender && gender === 'Male' ?
                                                    <img alt='male.jpg' className="h-[90px] w-[90px] rounded-full object-cover mx-auto sm:h-[110px] sm:w-[110px] sm:mx-0" src={`/assets/male.jpg`} /> :
                                                    <img alt='female.jpg' className="h-[90px] w-[90px] rounded-full object-cover mx-auto sm:h-[110px] sm:w-[110px] sm:mx-0" src={`/assets/female.jpg`} />
                                                :

                                                <img alt='avatar' className="h-[90px] w-[90px] rounded-full object-cover mx-auto sm:h-[110px] sm:w-[110px] sm:mx-0" src={avatar} />
